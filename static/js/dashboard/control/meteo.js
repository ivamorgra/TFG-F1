...
demo = {
  ...
  initDashboardPageCharts: function() {
    ...
    /* Datos de la grafica Evolución temperatura */
    const names = document.getElementById('json_names')
    const labels_names = JSON.parse(names.dataset.json);

    const temp = document.getElementById('json_temps')
    const data_temp = JSON.parse(temp.dataset.json);
    ...
    var data = {
      ...
      /* GRÁFICO DE SECTORES */
      const percentage = document.getElementById('json_avg_hum').getAttribute('data-json') 
    ...
    var myChart = new Chart(ctx, {
      type: 'pie',
      data: {
        labels: ['Humedad', 'Humedad restante'],
        datasets: [{
