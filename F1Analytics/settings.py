"""
Django settings for F1Analytics project.
...
SECRET_KEY = 'django-insecure-@pwcsiq*!k$$sz-4_!avwf=obrpwekc^ke#ylgllv2pbu8l2k*'
...
WSGI_APPLICATION = 'F1Analytics.wsgi.application'
